...
namespace BlazorECommerceApp.Server.Migrations
{
    ...
    [Migration("20220711054122_AddReview")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorECommerceApp.Shared.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorECommerceApp.Shared.Entities.OrderParticular", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorECommerceApp.Shared.Entities.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorECommerceApp.Shared.Entities.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorECommerceApp.Shared.Entities.OrderParticular", b =>
                {
                    b.HasOne("BlazorECommerceApp.Shared.Entities.Order", null)
                        .WithMany("OrderParticulars")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlazorECommerceApp.Shared.Entities.Product", "Product")
                        .WithMany()
